...
/* harmony import */ var _components_adaptiveText__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ./components/adaptiveText */ "./src/js/components/adaptiveText.js");
/* harmony import */ var _components_adaptiveText__WEBPACK_IMPORTED_MODULE_2___default = /*#__PURE__*/__webpack_require__.n(_components_adaptiveText__WEBPACK_IMPORTED_MODULE_2__);
...
/***/ "./src/js/components/adaptiveText.js":
/*!*******************************************!*\
  !*** ./src/js/components/adaptiveText.js ***!
  \*******************************************/
/***/ (() => {
...
const servicesTitle = document.querySelector(".services__title"),
  creditTitle = document.querySelector(".credit__title");
if (window.innerWidth < 576) {
  servicesTitle.textContent = "Цены на окна по акции";
  creditTitle.remove();
}
...
// Маска
inputs.forEach(item => {
  const mask = new imask__WEBPACK_IMPORTED_MODULE_0__["default"](item, {
    mask: '+{7}(000)000-00-00'
  });
});

// Форма1
new just_validate__WEBPACK_IMPORTED_MODULE_1__["default"](".hero__form").addField("#phone", [{
  rule: "required",
  ...
  rule: "required",
  errorMessage: 'Ознакомьтесь с политикой'
}]).onSuccess(event => {
  ...
  // В этом случае не будет успешной отправки так как mailer не настроен, вывод в консоль по событию submit выше.
...
// Форма2
new just_validate__WEBPACK_IMPORTED_MODULE_1__["default"](".record__form").addField("#phone1", [{
  rule: "required",
  errorMessage: 'Это поле обязательно'
}, {
  rule: 'minLength',
...
const serviceSlider = new swiper__WEBPACK_IMPORTED_MODULE_0__["default"](".services__slider", {
...
const paymentsSlider = new swiper__WEBPACK_IMPORTED_MODULE_0__["default"](".payment__slider", {
  direction: 'horizontal',
  breakpoints: {
    320: {
      slidesPerView: "auto",
...
const exampleSlider = new swiper__WEBPACK_IMPORTED_MODULE_0__["default"](".example__slider", {
  direction: 'horizontal',
  navigation: {
